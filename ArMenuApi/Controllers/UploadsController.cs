...
public class UploadsController : ControllerBase
{
    ...
    private async Task<ActionResult<object>> SaveFile(IFormFile file, string subfolder, string[] allowedExtensions)
    {
        ...
        // Falls back to building the path from ContentRootPath if
        // WebRootPath is null (happens if the wwwroot folder is missing) —
        // this is what threw the ArgumentNullException you just hit.
